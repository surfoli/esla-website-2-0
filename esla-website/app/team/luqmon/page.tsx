...
import { ArrowLeft, Calendar, MapPin, Trophy, Users, Heart, Shield, Star, Gamepad2, Target } from 'lucide-react';
          ...
          <div className="bg-gradient-to-br from-esla-secondary to-esla-dark text-white rounded-3xl p-8 md:p-12 mb-16 shadow-xl">
            <div className="flex flex-col md:flex-row items-center gap-x-8 gap-y-6">
              <div className="relative">
                <div className="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-esla-primary shadow-2xl">
                  <Image
                    src="/images/Luqmon_Adekunle.png"
                    alt="Luqmon Adekunle"
                    width={256}
                    height={256}
                ...
                <div className="absolute -bottom-2 -right-2 bg-esla-primary rounded-full p-3 shadow-lg">
              ...
              <div className="flex-1 text-center md:text-left">
                <h1 className="text-4xl md:text-6xl font-black mb-4">
                  Adekunle <span className="text-esla-primary">Babatunde Lukmon</span>
                </h1>
