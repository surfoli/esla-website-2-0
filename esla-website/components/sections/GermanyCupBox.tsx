    ...
    <section className="py-16 bg-white">
      <Container>
        <div className="w-full">
          ...
          >
            <div className="bg-black border border-black rounded-2xl p-8 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] cursor-pointer text-white">
              {/* Header */}
              <div className="text-center mb-8">
                <p className="text-xs font-semibold uppercase tracking-[0.35em] text-white/70 mb-5">
                  ESLA nimmt teil am
                </p>
                <div className="mx-auto mb-6 flex h-48 w-48 sm:h-56 sm:w-56 items-center justify-center rounded-full bg-white shadow-xl ring-2 ring-inset ring-[#e2c218]/50 border border-[#e2c218]/20">
                  <Image
              ...
              {/* Call to Action */}
              <div className="text-center">
                <div className="inline-flex items-center gap-2 text-[#e2c218] font-bold text-lg group-hover:gap-3 transition-all">
